...
class CopilotModal extends Component<Props, State> {
  ...
  renderTooltip() {
    ...
    return [
      ...
      <Animated.View key="tooltip" style={[styles.tooltip, this.props.tooltipStyle ]}>
        <TooltipComponent
          isFirstStep={this.props.isFirstStep}
          isLastStep={this.props.isLastStep}
          currentStep={this.props.currentStep}
  ...
  render() {
    ...
    return (
      ...
      >
        <TouchableOpacity activeOpacity={1} style={styles.container} onPress={ !isLastStep ? this.handleNext: this.handleStop}>
            <View
